    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('año', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='administracion.año')),
            ],
        ),
        migrations.CreateModel(
            name='Division',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tutor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='administracion.tutor')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fecha_ingreso', models.DateField(blank=True, null=True)),
                ('documentacion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='administracion.documentacion')),
